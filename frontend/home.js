...
let userTableDetail = [
  {
    localSupplyName: "mac",
    localSupplyCode: "some code",
    localSupplyTime: "some time",
  },
  {
    localSupplyName: "mac2",
    localSupplyCode: "some code2",
    localSupplyTime: "some time2",
  },
];

localStorage.setItem("userDetail", JSON.stringify(userTableDetail));
